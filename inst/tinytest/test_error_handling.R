...
expect_error(
  runServer(dir = NA, blocking = FALSE),
...
expect_error(
  runServer(dir = getwd(), addr = NA, blocking = FALSE),
...
expect_error(
  runServer(
    dir = getwd(),
    addr = c("127.0.0.1:8080", "127.0.0.1:8081"),
    blocking = FALSE
  ),
...
expect_error(
  runServer(dir = getwd(), addr = "127.0.0.1:-1", blocking = FALSE),
