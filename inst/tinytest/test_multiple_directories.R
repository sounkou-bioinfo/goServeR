...
shutdownServer(h1)
Sys.sleep(0.5)
cat("   Done: Backward compatibility test completed\n")
...
shutdownServer(h2)
Sys.sleep(0.5)
cat("   Done: Multiple directories test completed\n")
...
shutdownServer(h3)
Sys.sleep(0.5)
cat("   Done: Mixed directory types test completed\n")
...
cat("   Done: Validation errors test completed\n")
...
cat("   Done: Edge cases test completed\n")
...
cat("   Done: Configuration test completed\n")
...
cat("   Done: Concurrent servers test completed\n")
